...
d1 = function() {
  $('#i1').hide().html('<img src="Website Images/icons/h1.png" />').fadeIn("slow");
  $('#d1,#l1').fadeTo(1000, 1);
...
d2 = function() {
  $('#i1').hide().html('<img src="Website Images/icons/h2.png" />').fadeIn("slow");
...
d3 = function() {
  $('#i1').hide().html('<img src="Website Images/icons/h3.png" />').fadeIn("slow");
